...
// Esta es la variable que indica el host del servidor Postgres
	...
	$_SESSION["_CONTRASENA_CONEXION"]	= "dbnutricion_conexion" ;
	...
	$_SESSION["_BASE_DATOS"]= "dbnutricion";
	...
	//para determinar la claridad deb los errores
	// [desarrollo,produccion]
	$_SESSION["_ESTADO_SISTEMA"] = "produccion";  //produccion
